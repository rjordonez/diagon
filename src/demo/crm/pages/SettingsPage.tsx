      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" defaultValue="Sarah" className="form-input" />
          </div>
          <div>
            <label className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block mb-1.5">Last Name</label>
            <input type="text" defaultValue="Chen" className="form-input" />
          </div>
          <div className="sm:col-span-2">
            <label className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block mb-1.5">Email</label>
            <input type="email" defaultValue="sarah.chen@lendco.com" className="form-input" />
          </div>
          <div className="sm:col-span-2">
            <label className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground block mb-1.5">Phone</label>
            <input type="text" defaultValue="(415) 555-0100" className="form-input" />
          </div>
        </div>
      </div>
